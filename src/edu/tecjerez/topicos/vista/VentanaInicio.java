...
public class VentanaInicio extends JFrame implements ActionListener, KeyListener {
	...
	public void keyReleased(KeyEvent arg0) {
		if(!txtFP1X.getText().equals("") && !txtFP1Y.getText().equals("") &&
				!txtFP2X.getText().equals("") && !txtFP2Y.getText().equals("") &&
				!txtFP3X.getText().equals("") && !txtFP3Y.getText().equals("") &&
				!txtFArea.getText().equals("")){
